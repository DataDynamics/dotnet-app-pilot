...
///         <see cref="IResource" /> implementation integrate nicely
///         with the <see cref="ConfigurableResourceLoader" /> class.
///     </p>
/// </remarks>
...
public interface IResource : IInputStreamSource
{
    ...
    ///         <see cref="IResource.Exists" /> property prior to
    ...
    ///         <see cref="IResource.Exists" /> property.
    ///     </p>
    /// </remarks>
    /// <value>
