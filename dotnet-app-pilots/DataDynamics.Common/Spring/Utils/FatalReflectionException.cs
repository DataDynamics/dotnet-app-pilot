...
public class FatalReflectionException : ReflectionException
{
    ...
    /// </param>
    public FatalReflectionException(string message, Exception rootCause) : base(message, rootCause)
    {
    }
    ...
    /// </param>
    protected FatalReflectionException(SerializationInfo info, StreamingContext context) : base(info, context)
    {
    }
}