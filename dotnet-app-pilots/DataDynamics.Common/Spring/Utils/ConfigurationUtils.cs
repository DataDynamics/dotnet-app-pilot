...
public static class ConfigurationUtils
{
    ...
    public static IInternalConfigSystem SetConfigurationSystem(
        IInternalConfigSystem configSystem, bool enforce)
    {
        var s_configSystem =
        ...
        var innerConfigSystem =
            (IInternalConfigSystem)s_configSystem.GetValue(null);
